...
<html>
	<head>
		<title>Null Hacks - premium and private cheats</title>
		
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<link rel="stylesheet" href="style.css" />
		<link rel="stylesheet" href="assets/css/main.css" />
		<link rel="shortcut icon" href="hacklogo4.ico" type="image/x-icon">
	
<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<script>
     (adsbygoogle = window.adsbygoogle || []).push({
          google_ad_client: "ca-pub-6089176673679099",
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Nav -->
					<nav id="nav">
						<ul>
							<li><a href="#intro" class="active">Terms Of Service</a></li>
  ...
  <br /> <br />
										<p>1. Acceptance of Terms of Use<br />
...
<br />
2. Use License<br />
a. Permission is granted to temporarily download one copy of the materials (information or software) on this web site for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
...
<br />
4. Limitations<br />
In no event shall we or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption,) arising out of the use or inability to use the materials on this Internet site, even if we or an authorized associate has been notified orally or in writing of the possibility of such damage. Because some jurisdictions do not allow limitations on implied warranties, or limitations of liability for consequential or incidental damages, these limitations may not apply to you.
<br />
...
<br />
8. Governing Law<br />
Any claim relating to our web site shall be governed by the laws of the Switzerland without regard to its conflict of law provisions.
<br />
9. Subscriptions<br />
Refunds will only be given if there is a mistake that was made by us.
Subscriptions will only ever be exchanged for subscriptions of the equal or lower value when you made a mistake at the time of purchase and have not yet activated the service.
...
<br />
10. Online Gaming<br />
We accept no responsibility to your online gaming accounts as a result of using this website or any software, or data contained within. You, the user, are solely responsible for your online gaming activities and any loss to any of your online gaming accounts, whether financial or not, is your responsibility.

When cheating, you choose to volontary break your games End User Licence Agreements, we can not be taken responsible if you loose your game account or/and get any damage caused by cheating. We are not liable for potential claims caused by one of their consumers on intellectual property of third parties. In such events the consumer protects us for claims from third parties.
<br />
Privacy Policy<br />
...
We are committed to conducting our business in accordance with these principles in order to ensure that the confidentiality of personal information is protected and maintained. </p>
										<a class="button special" href="http://vceenhanced.tk">Go Back To Site</a>
										<a href="http://steamcommunity.com/groups/420KushKushHacks" class="button special" target="_blank">Join My Steam Group!</a>
									</div>
